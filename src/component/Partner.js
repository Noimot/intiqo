  ...
  return (
    <section className="bg-[#4e4e4e] py-20 px-10 sm:px-14 md:px-20 lg:px-40" id="partners">
      <div className="text-center text-white">
        <h1 className="text-4xl font-semibold text-center text-[#C87759]">Our Customers</h1>
        <p className="py-7">
          We have shown good ethics with our customers and we always make sure
          our customers never find fault with us and we also set in place a
          standardize rules and regulation for our workers in order to relate
          ideally with our customers at all time. We have been known within and
